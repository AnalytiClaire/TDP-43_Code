...
RawExp <- read.csv("eset_NineP_150612_exprs.csv") 

Exp <-merge(ID, RawExp, by.x="ProbeID", by.y="X") #merge raw expression data with accepted genes
...
Exp <- Exp[,1:8] #Take only patients
...
setwd ("/Users/clairegreen/Documents/PhD/TDP-43/TDP-43_Data/WGCNA/C9orf72/PatOnly/")
net = blockwiseModules(Pat, power = 6,
