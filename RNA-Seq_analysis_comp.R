...
RNA_deseq2 <- read.table("/Users/clairegreen/Documents/PhD/TDP-43/TDP-43_Code/Results/GeneExpression/Guillaume_HEK48h/DEseq2/CG_TRL_Gene_DESeq2.txt")
RNA_deseq2 <- RNA_deseq2$V1

RNA_all <- read.csv("/Users/clairegreen/Documents/PhD/TDP-43/TDP-43_Code/Results/GeneExpression/Guillaume_HEK48h/Limma/TRL_Comparison.csv")
RNA_limma <- RNA_limma$CG

SA_TRL <- RNA_all$SA
LC_TRL <- RNA_all$LC

RNA_EdgeR <- read.table("/Users/clairegreen/Documents/PhD/TDP-43/TDP-43_Code/Results/GeneExpression/Guillaume_HEK48h/EdgeR/TRL_diffexpr-genes.txt")
