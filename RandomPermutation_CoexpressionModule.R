...
C9 <- read.csv("/Volumes/Storage 1/TDP-43/Coexpression/C9_cormatrix.csv", row.names = 1)
sALS <- read.csv("/Volumes/Storage 1/TDP-43/Coexpression/sALS_cormatrix.csv", row.names = 1)
FTLD <- read.csv("/Volumes/Storage 1/TDP-43/Coexpression/FTLD_cormatrix.csv", row.names = 1)
VCP <- read.csv("/Volumes/Storage 1/TDP-43/Coexpression/VCP_cormatrix.csv", row.names = 1)
PET <- read.csv("/Volumes/Storage 1/TDP-43/Coexpression/PET_cormatrix.csv", row.names = 1)
RAV <- read.csv("/Volumes/Storage 1/TDP-43/Coexpression/RAV_cormatrix.csv", row.names = 1)
