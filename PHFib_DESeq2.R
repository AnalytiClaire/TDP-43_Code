...
setwd("/users/clairegreen/Documents/PhD/TDP-43/TDP-43_Code/Results/GeneExpression/PH_Fibroblasts/")
counts <- read.table("Counts/annotated_combinedcounts.txt", header = T, row.names = 1)


counts.g<- counts[,1:30]
counts.g <- counts.g[,c(1:3,7,4:6,8:13,17,14:16,18:23,27,24:26,28:30)]
...
setwd("/users/clairegreen/Documents/PhD/TDP-43/TDP-43_Code/Results/GeneExpression/PH_Fibroblasts/trunc.v.missense/")
write.csv(genesort, "NUC_trunc.v.missense_norm.csv", row.names = F)
