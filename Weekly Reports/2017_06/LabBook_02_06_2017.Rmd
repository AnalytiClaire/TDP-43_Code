---
title: "LabBook_02_06_2017"
author: "Claire Green"
---

#Monday
This week I began work on making a PPI network using my 285 DEGs. Sandeep gave me a file from iref14 that had uniprot IDs for each protein interaction. I took any row which contained one of my 285 genes and this generated a network of ~3500 nodes and ~7000 edges. The network file is "PPI_cytoscape.cys". 
...
From this I created cytoscape networks for each of the individual gene backgrounds and looked for the overlap of proteins for just one mutation (and not any others). The functional enrichments for each of the three mutations (C9orf72, GRN, VCP) can be found in their individual folders at /Users/clairegreen/Documents/PhD/TDP-43/TDP-43_Code/Results/PPI_Network
