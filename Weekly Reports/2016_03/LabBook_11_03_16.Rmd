...
View this .csv file in the terminal. It may look like a long line of information separated by "^M"s. run "vim filename.csv" and separate the rows out and delete the ^Ms.
