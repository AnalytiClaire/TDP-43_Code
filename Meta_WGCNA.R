...
#Comparing networks with different module definitions#

#check to see which modules in network 1 contain a significant number of overlapping genes with modules in 2. 
#These would then be modules in the two networks that correspond to one another, and the labels from one network 
#could be remapped such that corresponding modules are assigned the same color.
