...
DEG_list <- read.table("~/Documents/PhD/TDP-43/TDP-43_Code/Results/GeneExpression/FoldChangeResults/Filtered_upanddown.txt")
DEG_list <- DEG_list$V1
genelist <- read.table("~/Documents/PhD/TDP-43/TDP-43_Code/Results/PPI_Network/Coexpression/GRN/GRNtop100.txt")
